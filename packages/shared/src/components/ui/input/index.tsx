...
type IInputProps = React.ComponentPropsWithoutRef<typeof UIInput> &
  VariantProps<typeof inputStyle> & {
    className?: string;
    ref?: React.Ref<React.ComponentRef<typeof UIInput>>;
  };
...
function InputIcon({ ref, className, size, ...props }: IInputIconProps) {
...
function InputSlot({ ref, className, ...props }: IInputSlotProps) {
  return (
    <UIInput.Slot
      ref={ref}
      {...props}
