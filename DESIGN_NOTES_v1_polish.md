...
| Change                                                                                    | Why                                                                                                                                                                                                                                                                                     |
| ----------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Fraunces({ axes: ['opsz'] })` (was `Fraunces({ weight: ['400','700','900'] })`, no axes) | Fraunces ships an optical-size axis that auto-tunes letterforms for display vs body sizes — using it is free quality you were leaving on the table. Omitting `weight` loads the full variable font, which covers all weights and is what `next/font/google` expects for variable fonts. |
