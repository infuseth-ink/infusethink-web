  ...
  return (
    <section className="bg-brand-parchment px-6 py-4">
      <div className="mx-auto max-w-6xl">
        <p className="text-brand-green mb-4 text-center text-xs font-bold tracking-[0.2em] uppercase opacity-70">
          Featured course series
        </p>
        <h2 className="font-display text-foreground mb-4 text-center text-3xl font-bold tracking-tight sm:text-4xl">
          Software Engineering with Python
        </h2>
        <p className="text-muted-foreground mx-auto mb-16 max-w-xl text-center text-base leading-relaxed">
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-0 lg:grid-cols-2">
            ...
            <div className="p-10 lg:p-14" style={{ borderLeft: '1px solid var(--border)' }}>
              <p className="text-muted-foreground mb-5 text-xs font-bold tracking-widest uppercase">
                Series outline
              </p>
              <ol className="grid grid-cols-2 gap-x-6 gap-y-6">
                  ...
                  <li key={title}>
                    ...
                    <ul className="ml-7 flex flex-col gap-1">
                      {lessons.map((lesson) => (
                        ...
                        >
                          <span className="bg-brand-gold/50 h-1 w-1 shrink-0 rounded-full" />
                          {lesson}
                        </li>
                      ))}
                      <li className="text-muted-foreground/50 mt-0.5 ml-2.5 text-xs">
                        +{more} more lessons
                      </li>
                    </ul>
                  </li>
              ...
              <p className="text-muted-foreground mt-6 text-xs">+ 44 more chapters</p>
            </div>
          </div>
        </div>
      </div>
