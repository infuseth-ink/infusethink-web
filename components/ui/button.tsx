...
const buttonVariants = cva(
  ...
  `,
  {
    variants: {
      ...
      size: {
        default: `
          gap-1.5 px-2.5 block-8
          has-data-[icon=inline-end]:pe-2
          has-data-[icon=inline-start]:ps-2
        `,
        xs: `
          gap-1 rounded-[min(var(--radius-md),10px)] px-2 text-xs block-6
        ...
        `,
        sm: `
          gap-1 rounded-[min(var(--radius-md),12px)] px-2.5 text-[0.8rem]
          block-7
          in-data-[slot=button-group]:rounded-lg
          has-data-[icon=inline-end]:pe-1.5
          has-data-[icon=inline-start]:ps-1.5
        ...
        `,
        lg: `
          gap-1.5 px-2.5 block-9
          has-data-[icon=inline-end]:pe-2
          has-data-[icon=inline-start]:ps-2
        `,
        icon: 'block-8 inline-8',
        'icon-xs': `
          rounded-[min(var(--radius-md),10px)] block-6 inline-6
          in-data-[slot=button-group]:rounded-lg
          [&_svg:not([class*='size-'])]:block-3
          [&_svg:not([class*='size-'])]:inline-3
        `,
        'icon-sm': `
          rounded-[min(var(--radius-md),12px)] block-7 inline-7
          in-data-[slot=button-group]:rounded-lg
        `,
        'icon-lg': 'block-9 inline-9',
      },
    },
    defaultVariants: {
      variant: 'default',
